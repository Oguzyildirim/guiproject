...
public class SignUp extends AppCompatActivity implements View.OnClickListener {
    ...
    Button btnSignup;
    TextView btnLogin,btnForgotPass,btnVisitor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVisitor = (TextView)findViewById(R.id.visitor);
    ...
    public void onClick(View view) {
            ...
            else if(view.getId() == R.id.visitor){

                startActivity(new Intent(SignUp.this,VisitorActivity.class));
                //finish();
            }
    }
